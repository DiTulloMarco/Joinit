...
export default async function EventsPage() {
  ...
  return (
    <main className="flex-1 p-8">
      ...
      <EventCard title={featuredEvent.title} desc={featuredEvent.desc} date={featuredEvent.date} location={featuredEvent.location} canJoin={true} />
