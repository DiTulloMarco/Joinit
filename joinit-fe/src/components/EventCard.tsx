      ...
      <div className="">
        ...
        <div className="flex space-x-10 items-center">
          ...
          {window.location.pathname.includes(AppRoutes.EVENT + props.event.id) && (
            <button
              onClick={handleGetCalendarFile}
              className="secondary-button mt-2 min-w-28 opacity-60 !w-1/3 hover:underline"
            >
          ...
          {!window.location.pathname.includes(AppRoutes.EVENT + props.event.id) && (
            <a href={AppRoutes.EVENT + props.event.id} className="mt-1 opacity-70 hover:opacity-90">
              vedi dettagli →
            </a>
          )}
        </div>
